...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_VRExpansionPlugin_ESecondaryGripType_CRC() { return 2302656961U; }
	UEnum* Z_Construct_UEnum_VRExpansionPlugin_ESecondaryGripType()
	{
		...
		if (!ReturnEnum)
		{
			...
			static const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "SG_ScalingOnly.ToolTip", "Does nothing, just provides the events for personal use" },
	...
	uint32 Get_Z_Construct_UEnum_VRExpansionPlugin_EBPHMDDeviceType_CRC() { return 3001304814U; }
	...
	uint32 Get_Z_Construct_UEnum_VRExpansionPlugin_EVRConjoinedMovementModes_CRC() { return 3748207932U; }
	...
	uint32 Get_Z_Construct_UEnum_VRExpansionPlugin_EVRCustomMovementMode_CRC() { return 3332824908U; }
...
static struct FScriptStruct_VRExpansionPlugin_StaticRegisterNativesFBPInterfaceProperties
{
	...
	uint32 Get_Z_Construct_UScriptStruct_FBPInterfaceProperties_CRC() { return 530037494U; }
...
static struct FScriptStruct_VRExpansionPlugin_StaticRegisterNativesFBPActorGripInformation
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FBPActorGripInformation()
	{
		...
		if (!ReturnStruct)
		{
...
#endif
			auto NewProp_bIsPaused_SetBit = [](void* Obj){ ((FBPActorGripInformation*)Obj)->bIsPaused = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bIsPaused = { UE4CodeGen_Private::EPropertyClass::Bool, "bIsPaused", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000080000004, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(FBPActorGripInformation), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bIsPaused_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bIsPaused_MetaData, ARRAY_COUNT(NewProp_bIsPaused_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FNamePropertyParams NewProp_GrippedBoneName = { UE4CodeGen_Private::EPropertyClass::Name, "GrippedBoneName", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000004, 1, nullptr, STRUCT_OFFSET(FBPActorGripInformation, GrippedBoneName), METADATA_PARAMS(NewProp_GrippedBoneName_MetaData, ARRAY_COUNT(NewProp_GrippedBoneName_MetaData)) };
#if WITH_METADATA
			...
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bIsPaused,
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_GrippedBoneName,
	...
	uint32 Get_Z_Construct_UScriptStruct_FBPActorGripInformation_CRC() { return 2808306813U; }
...
static struct FScriptStruct_VRExpansionPlugin_StaticRegisterNativesFBPAdvGripSettings
{
...
#endif
			static const UE4CodeGen_Private::FBytePropertyParams NewProp_GripPriority = { UE4CodeGen_Private::EPropertyClass::Byte, "GripPriority", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, STRUCT_OFFSET(FBPAdvGripSettings, GripPriority), nullptr, METADATA_PARAMS(NewProp_GripPriority_MetaData, ARRAY_COUNT(NewProp_GripPriority_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
	...
	uint32 Get_Z_Construct_UScriptStruct_FBPAdvGripSettings_CRC() { return 3611831351U; }
