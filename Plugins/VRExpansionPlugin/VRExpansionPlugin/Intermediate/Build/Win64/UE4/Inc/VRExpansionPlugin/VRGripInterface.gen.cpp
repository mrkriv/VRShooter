...
// End Cross Module References
	...
	void UVRGripInterface::StaticRegisterNativesUVRGripInterface()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "GetInteractionSettings", &IVRGripInterface::execGetInteractionSettings },
			...
			{ "IsInteractible", &IVRGripInterface::execIsInteractible },
	...
	UClass* Z_Construct_UClass_UVRGripInterface()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				...
				{ &Z_Construct_UFunction_UVRGripInterface_GetGripStiffnessAndDamping, "GetGripStiffnessAndDamping" }, // 3711106771
	...
	IMPLEMENT_CLASS(UVRGripInterface, 70888714);
