...
// Cross Module References
	...
	VREXPANSIONPLUGIN_API UFunction* Z_Construct_UFunction_UVRSliderComponent_ReceiveSliderHitPoint();
	...
	VREXPANSIONPLUGIN_API UFunction* Z_Construct_UFunction_UVRSliderComponent_SetSliderProgress();
...
// End Cross Module References
	UFunction* Z_Construct_UDelegateFunction_VRExpansionPlugin_VRSliderHitPointSignature__DelegateSignature()
	{
		...
		if (!ReturnFunction)
		{
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_SliderProgressPoint = { UE4CodeGen_Private::EPropertyClass::Float, "SliderProgressPoint", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, STRUCT_OFFSET(_Script_VRExpansionPlugin_eventVRSliderHitPointSignature_Parms, SliderProgressPoint), METADATA_PARAMS(nullptr, 0) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_SliderProgressPoint,
			};
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FFunctionParams FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_VRExpansionPlugin, "VRSliderHitPointSignature__DelegateSignature", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x00130000, sizeof(_Script_VRExpansionPlugin_eventVRSliderHitPointSignature_Parms), PropPointers, ARRAY_COUNT(PropPointers), 0, 0, METADATA_PARAMS(Function_MetaDataParams, ARRAY_COUNT(Function_MetaDataParams)) };
	...
	uint32 Get_Z_Construct_UEnum_VRExpansionPlugin_EVRInteractibleSliderLerpType_CRC() { return 413076757U; }
	UEnum* Z_Construct_UEnum_VRExpansionPlugin_EVRInteractibleSliderLerpType()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_VRExpansionPlugin();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EVRInteractibleSliderLerpType"), 0, Get_Z_Construct_UEnum_VRExpansionPlugin_EVRInteractibleSliderLerpType_CRC(), false);
#else
	...
	void UVRSliderComponent::StaticRegisterNativesUVRSliderComponent()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "AdvancedGripSettings", &UVRSliderComponent::execAdvancedGripSettings },
			{ "ClosestGripSlotInRange", &UVRSliderComponent::execClosestGripSlotInRange },
			{ "DenyGripping", &UVRSliderComponent::execDenyGripping },
			{ "GetGripStiffnessAndDamping", &UVRSliderComponent::execGetGripStiffnessAndDamping },
			{ "GetInteractionSettings", &UVRSliderComponent::execGetInteractionSettings },
			{ "GetPrimaryGripType", &UVRSliderComponent::execGetPrimaryGripType },
			{ "GripBreakDistance", &UVRSliderComponent::execGripBreakDistance },
			{ "GripLateUpdateSetting", &UVRSliderComponent::execGripLateUpdateSetting },
			{ "GripMovementReplicationType", &UVRSliderComponent::execGripMovementReplicationType },
			{ "IsHeld", &UVRSliderComponent::execIsHeld },
			{ "IsInteractible", &UVRSliderComponent::execIsInteractible },
			{ "OnChildGrip", &UVRSliderComponent::execOnChildGrip },
			{ "OnChildGripRelease", &UVRSliderComponent::execOnChildGripRelease },
			{ "OnEndSecondaryUsed", &UVRSliderComponent::execOnEndSecondaryUsed },
			{ "OnEndUsed", &UVRSliderComponent::execOnEndUsed },
			{ "OnGrip", &UVRSliderComponent::execOnGrip },
			{ "OnGripRelease", &UVRSliderComponent::execOnGripRelease },
			{ "OnInput", &UVRSliderComponent::execOnInput },
			{ "OnSecondaryGrip", &UVRSliderComponent::execOnSecondaryGrip },
			{ "OnSecondaryGripRelease", &UVRSliderComponent::execOnSecondaryGripRelease },
			{ "OnSecondaryUsed", &UVRSliderComponent::execOnSecondaryUsed },
			{ "OnUsed", &UVRSliderComponent::execOnUsed },
			{ "ResetInitialSliderLocation", &UVRSliderComponent::execResetInitialSliderLocation },
			{ "SecondaryGripType", &UVRSliderComponent::execSecondaryGripType },
			{ "SetHeld", &UVRSliderComponent::execSetHeld },
			...
			{ "SimulateOnDrop", &UVRSliderComponent::execSimulateOnDrop },
			{ "TeleportBehavior", &UVRSliderComponent::execTeleportBehavior },
			{ "TickGrip", &UVRSliderComponent::execTickGrip },
		};
	...
	UFunction* Z_Construct_UFunction_UVRSliderComponent_ReceiveSliderHitPoint()
	{
		...
		if (!ReturnFunction)
		{
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_SliderProgressPoint = { UE4CodeGen_Private::EPropertyClass::Float, "SliderProgressPoint", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, STRUCT_OFFSET(VRSliderComponent_eventReceiveSliderHitPoint_Parms, SliderProgressPoint), METADATA_PARAMS(nullptr, 0) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_SliderProgressPoint,
			};
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FFunctionParams FuncParams = { (UObject*(*)())Z_Construct_UClass_UVRSliderComponent, "ReceiveSliderHitPoint", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x08020800, sizeof(VRSliderComponent_eventReceiveSliderHitPoint_Parms), PropPointers, ARRAY_COUNT(PropPointers), 0, 0, METADATA_PARAMS(Function_MetaDataParams, ARRAY_COUNT(Function_MetaDataParams)) };
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, FuncParams);
		}
		return ReturnFunction;
	}
	...
	UFunction* Z_Construct_UFunction_UVRSliderComponent_SetSliderProgress()
	{
		...
		if (!ReturnFunction)
		{
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_NewSliderProgress = { UE4CodeGen_Private::EPropertyClass::Float, "NewSliderProgress", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, STRUCT_OFFSET(VRSliderComponent_eventSetSliderProgress_Parms, NewSliderProgress), METADATA_PARAMS(nullptr, 0) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_NewSliderProgress,
			};
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
				{ "Category", "VRSliderComponent" },
...
#endif
			static const UE4CodeGen_Private::FFunctionParams FuncParams = { (UObject*(*)())Z_Construct_UClass_UVRSliderComponent, "SetSliderProgress", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04020401, sizeof(VRSliderComponent_eventSetSliderProgress_Parms), PropPointers, ARRAY_COUNT(PropPointers), 0, 0, METADATA_PARAMS(Function_MetaDataParams, ARRAY_COUNT(Function_MetaDataParams)) };
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, FuncParams);
		}
		return ReturnFunction;
	}
	...
	UClass* Z_Construct_UClass_UVRSliderComponent()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				...
				{ &Z_Construct_UFunction_UVRSliderComponent_ReceiveSliderHitPoint, "ReceiveSliderHitPoint" }, // 1787174647
				...
				{ &Z_Construct_UFunction_UVRSliderComponent_SetSliderProgress, "SetSliderProgress" }, // 1116378370
...
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_SnapThreshold = { UE4CodeGen_Private::EPropertyClass::Float, "SnapThreshold", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UVRSliderComponent, SnapThreshold), METADATA_PARAMS(NewProp_SnapThreshold_MetaData, ARRAY_COUNT(NewProp_SnapThreshold_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_SnapIncrement = { UE4CodeGen_Private::EPropertyClass::Float, "SnapIncrement", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UVRSliderComponent, SnapIncrement), METADATA_PARAMS(NewProp_SnapIncrement_MetaData, ARRAY_COUNT(NewProp_SnapIncrement_MetaData)) };
#if WITH_METADATA
...
#endif
			auto NewProp_bSliderUsesSnapPoints_SetBit = [](void* Obj){ ((UVRSliderComponent*)Obj)->bSliderUsesSnapPoints = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bSliderUsesSnapPoints = { UE4CodeGen_Private::EPropertyClass::Bool, "bSliderUsesSnapPoints", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UVRSliderComponent), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bSliderUsesSnapPoints_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bSliderUsesSnapPoints_MetaData, ARRAY_COUNT(NewProp_bSliderUsesSnapPoints_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FFloatPropertyParams NewProp_SplineLerpValue = { UE4CodeGen_Private::EPropertyClass::Float, "SplineLerpValue", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UVRSliderComponent, SplineLerpValue), METADATA_PARAMS(NewProp_SplineLerpValue_MetaData, ARRAY_COUNT(NewProp_SplineLerpValue_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FEnumPropertyParams NewProp_SplineLerpType = { UE4CodeGen_Private::EPropertyClass::Enum, "SplineLerpType", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UVRSliderComponent, SplineLerpType), Z_Construct_UEnum_VRExpansionPlugin_EVRInteractibleSliderLerpType, METADATA_PARAMS(NewProp_SplineLerpType_MetaData, ARRAY_COUNT(NewProp_SplineLerpType_MetaData)) };
			static const UE4CodeGen_Private::FBytePropertyParams NewProp_SplineLerpType_Underlying = { UE4CodeGen_Private::EPropertyClass::Byte, "UnderlyingType", RF_Public|RF_Transient|RF_MarkAsNative, 0x0000000000000000, 1, nullptr, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
			auto NewProp_bEnforceSplineLinearity_SetBit = [](void* Obj){ ((UVRSliderComponent*)Obj)->bEnforceSplineLinearity = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_bEnforceSplineLinearity = { UE4CodeGen_Private::EPropertyClass::Bool, "bEnforceSplineLinearity", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(UVRSliderComponent), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_bEnforceSplineLinearity_SetBit)>::SetBit, METADATA_PARAMS(NewProp_bEnforceSplineLinearity_MetaData, ARRAY_COUNT(NewProp_bEnforceSplineLinearity_MetaData)) };
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam NewProp_bFollowSplineRotationAndScale_MetaData[] = {
				{ "Category", "VRSliderComponent" },
				{ "ModuleRelativePath", "Public/Interactibles/VRSliderComponent.h" },
				{ "ToolTip", "Where the slider should follow the rotation and scale of the spline as well" },
			};
#endif
...
#endif
			static const UE4CodeGen_Private::FUnsizedIntPropertyParams NewProp_GripPriority = { UE4CodeGen_Private::EPropertyClass::Int, "GripPriority", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000005, 1, nullptr, STRUCT_OFFSET(UVRSliderComponent, GripPriority), METADATA_PARAMS(NewProp_GripPriority_MetaData, ARRAY_COUNT(NewProp_GripPriority_MetaData)) };
#if WITH_METADATA
...
#endif
			static const UE4CodeGen_Private::FMulticastDelegatePropertyParams NewProp_OnSliderHitPoint = { UE4CodeGen_Private::EPropertyClass::MulticastDelegate, "OnSliderHitPoint", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000010080000, 1, nullptr, STRUCT_OFFSET(UVRSliderComponent, OnSliderHitPoint), Z_Construct_UDelegateFunction_VRExpansionPlugin_VRSliderHitPointSignature__DelegateSignature, METADATA_PARAMS(NewProp_OnSliderHitPoint_MetaData, ARRAY_COUNT(NewProp_OnSliderHitPoint_MetaData)) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bSliderUsesSnapPoints,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_SplineLerpValue,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_SplineLerpType,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_SplineLerpType_Underlying,
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_bEnforceSplineLinearity,
				...
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_OnSliderHitPoint,
			};
	...
	IMPLEMENT_CLASS(UVRSliderComponent, 954074566);
